...
urlpatterns = [
    ...
    path('admin-approve-request/<int:pk>', views.admin_approve_request_view,name='admin-approve-request'),
    path('admin-reject-request/<int:pk>', views.admin_disapprove_request_view,name='admin-reject-request'),
